...
public:
    ...
    static BigNum calc_x(const BigNum& s, std::u16string I, std::u16string p);
    static BigNum calc_x(const BigNum& s, std::u16string I, const ByteArray& p);
    ...
    static BigNum calc_v(std::u16string I, std::u16string p, const BigNum& s,
                         const BigNum& N, const BigNum& g);

    static BigNum calc_v(const std::u16string I, const ByteArray& p, const BigNum& s,
                         const BigNum& N, const BigNum& g);
